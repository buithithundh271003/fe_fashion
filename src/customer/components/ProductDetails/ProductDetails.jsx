      ...
      <div className="pt-6 container mx-auto px-4">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="w-full h-96 bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center group">
  <img
    src={product?.images?.[0]?.thumbUrl || "https://via.placeholder.com/500x500?text=No+Image"}
